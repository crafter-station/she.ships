    ...
    >
      ...
      <div className="relative flex flex-col items-center text-center">
        ...
        <p className="mb-4 font-script text-xl text-rose-coral md:text-2xl">
          Where women build and ship
        </p>

        {/* Main headline */}
        <h1 className="mb-6 max-w-4xl text-5xl font-extrabold leading-tight tracking-tight text-white md:text-7xl lg:text-8xl">
          Just <span className="text-rose-coral">Ship It.</span>
        </h1>

        <p className="mb-10 max-w-2xl text-lg text-warm-gray md:text-xl">
          A global event for women turning ideas into real products. With
          mentorship, AI tools, and zero barriers.{" "}
          <span className="text-white font-medium">March 8, 2026.</span>
        </p>
